...
- [GPT-5.5 x402 API Gateway](https://gpt55.558686.xyz) - OpenAI-compatible GPT-5.5 chat completions and text tools over x402 USDC on Base. Compact chat is $0.0001 per request, long-output chat is $0.002134 up to 4096 output tokens, and true max-output chat is $0.066667 up to 128000 output tokens. Supports exact and token-metered upto settlement with no subscription or public API key required. ([Discovery](https://gpt55.558686.xyz/.well-known/x402) | [OpenAPI](https://gpt55.558686.xyz/openapi.json) | [Pricing](https://gpt55.558686.xyz/pricing.json))
